...
5. **マルチプレイヤーはアーキテクチャの請求書を伴うプロダクト機能です:** プレゼンス、カーソル、即時フィードバック([プレゼンス](../07-real-time/06-presence.md)、[WebSocket](/07-real-time/01-polling.md#websocket))は同じセッションサーバーに乗ります — ドキュメントの権威と同居させることが、それらを安価にするのです。
